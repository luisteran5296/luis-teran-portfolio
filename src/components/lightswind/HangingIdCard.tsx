...
export const HangingIdCard = ({
  ...
  useEffect(() => {
    // Initial impulse on first mount so user immediately identifies it as an interactive element
    const timer = setTimeout(() => {
      physRef.current.angle = 0.26; // ~15 degrees initial swing
      physRef.current.vel = -1.6;
      setAngle(0.26);
      startPhysics();
    }, 400);
